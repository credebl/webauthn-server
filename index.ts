...
// support is enabled)
const expectedOrigin = process.env.EXPECTED_ORIGINS ? JSON.parse(process.env.EXPECTED_ORIGINS) : DEFAULT_EXPECTED_ORIGINS;; // Change expectedOrigin according to environment
